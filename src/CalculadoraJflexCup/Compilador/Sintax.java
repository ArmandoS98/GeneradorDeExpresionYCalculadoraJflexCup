...
// Wed Apr 28 20:47:14 CST 2021
//----------------------------------------------------
package CalculadoraJflexCup.Compilador;

import CalculadoraJflexCup.Tree.*;
import CalculadoraJflexCup.Operaciones.*;

/**
 * CUP v0.11a beta 20060608 generated parser.
 *
 * @version Wed Apr 28 20:47:14 CST 2021
 */
public class Sintax extends java_cup.runtime.lr_parser {
    ...
    protected static final short[][] _action_table
            = unpackFromStrings(new String[]{
        "\000\023\000\012\011\010\013\005\014\004\015\006\001"
        + "\002\000\016\002\ufff8\004\ufff8\005\ufff8\006\ufff8\007\ufff8"
        + "\012\ufff8\001\002\000\016\002\ufff9\004\ufff9\005\ufff9\006"
        + "\ufff9\007\ufff9\012\ufff9\001\002\000\020\002\ufffa\004\ufffa"
        + "\005\ufffa\006\ufffa\007\ufffa\010\024\012\ufffa\001\002\000"
        + "\014\002\023\004\013\005\015\006\014\007\016\001\002"
        + "\000\012\011\010\013\005\014\004\015\006\001\002\000"
        + "\014\004\013\005\015\006\014\007\016\012\012\001\002"
        + "\000\016\002\ufffc\004\ufffc\005\ufffc\006\ufffc\007\ufffc\012"
        + "\ufffc\001\002\000\012\011\010\013\005\014\004\015\006"
        + "\001\002\000\012\011\010\013\005\014\004\015\006\001"
        + "\002\000\012\011\010\013\005\014\004\015\006\001\002"
        + "\000\012\011\010\013\005\014\004\015\006\001\002\000"
        + "\016\002\ufffd\004\ufffd\005\ufffd\006\ufffd\007\ufffd\012\ufffd"
        + "\001\002\000\016\002\uffff\004\uffff\005\uffff\006\014\007"
        + "\016\012\uffff\001\002\000\016\002\ufffe\004\ufffe\005\ufffe"
        + "\006\ufffe\007\ufffe\012\ufffe\001\002\000\016\002\001\004"
        + "\001\005\001\006\014\007\016\012\001\001\002\000\004"
        + "\002\000\001\002\000\012\011\010\013\005\014\004\015"
    ...
    protected static final short[][] _reduce_table
            = unpackFromStrings(new String[]{
        "\000\023\000\004\002\006\001\001\000\002\001\001\000"
        + "\002\001\001\000\002\001\001\000\002\001\001\000\004"
        + "\002\010\001\001\000\002\001\001\000\002\001\001\000"
        + "\004\002\021\001\001\000\004\002\020\001\001\000\004"
        + "\002\017\001\001\000\004\002\016\001\001\000\002\001"
        + "\001\000\002\001\001\000\002\001\001\000\002\001\001"
        + "\000\002\001\001\000\004\002\024\001\001\000\002\001"
        + "\001"});
    ...
    public final java_cup.runtime.Symbol CUP$Sintax$do_action(
        ...
        switch (CUP$Sintax$act_num) {
            ...
            case 9: // expr ::= DOU_NUMBER 
            {
                ...
                Double n = (Double) ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()).value;
                RESULT = new Literal(n);
                CUP$Sintax$result = parser.getSymbolFactory().newSymbol("expr", 0, ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()), ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()), RESULT);
            }
            return CUP$Sintax$result;

            /*. . . . . . . . . . . . . . . . . . . .*/
            case 8: // expr ::= INT_NUMBER 
            {
                Tree RESULT = null;
                int nleft = ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()).left;
                int nright = ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()).right;
            ...
            case 6: // expr ::= IDENT ASSIGN expr 
            {
                ...
                Tree e = (Tree) ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()).value;
                RESULT = new Assignment(s, e);
                CUP$Sintax$result = parser.getSymbolFactory().newSymbol("expr", 0, ((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top - 2)), ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()), RESULT);
            }
            return CUP$Sintax$result;
            ...
            case 5: // expr ::= LPAREN expr RPAREN 
            {
                ...
                Tree e = (Tree) ((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top - 1)).value;
                RESULT = e;
                CUP$Sintax$result = parser.getSymbolFactory().newSymbol("expr", 0, ((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top - 2)), ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()), RESULT);
            }
            return CUP$Sintax$result;
            ...
            case 4: // expr ::= expr DIV expr 
            {
                ...
                Tree e1 = (Tree) ((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top - 2)).value;
                ...
                Tree e2 = (Tree) ((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()).value;
            ...
            case 1: // $START ::= expr EOF 
            {
                ...
                Tree start_val = (Tree) ((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top - 1)).value;
                RESULT = start_val;
